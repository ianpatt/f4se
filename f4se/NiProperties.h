...
public:
	...
	DEFINE_MEMBER_FN(SetMaterial, bool, 0x02169620, BSShaderMaterial * material, bool unk1);
	DEFINE_MEMBER_FN(SetFlag, void, 0x02169460, UInt8 flags, bool enabled); // sets or unsets particular flags
};
...
public:
	...
	DEFINE_MEMBER_FN(ctor, void, 0x021774D0);
...
public:
	...
	DEFINE_MEMBER_FN(ctor, BSLightingShaderProperty *, 0x02179130);
	DEFINE_MEMBER_FN(MakeValidForRendering, void, 0x021793F0, BSGeometry * geometry); // previously InvalidateShader
	DEFINE_MEMBER_FN(LoadTextureSet, void, 0x02179AA0, UInt32 unk1); // unk1 usually 0, called after material Releases textures (previously InvalidateTextures)
