...
public:
	...
	DEFINE_MEMBER_FN(SetMaterial, bool, 0x02161BF0, BSShaderMaterial * material, bool unk1);
	DEFINE_MEMBER_FN(SetFlag, void, 0x02161A30, UInt8 flags, bool enabled); // sets or unsets particular flags
};
...
public:
	...
	DEFINE_MEMBER_FN(ctor, void, 0x0216FAA0);
...
public:
	...
	DEFINE_MEMBER_FN(ctor, BSLightingShaderProperty *, 0x02171700);
	DEFINE_MEMBER_FN(MakeValidForRendering, void, 0x021719C0, BSGeometry * geometry); // previously InvalidateShader
	DEFINE_MEMBER_FN(LoadTextureSet, void, 0x02172070, UInt32 unk1); // unk1 usually 0, called after material Releases textures (previously InvalidateTextures)
