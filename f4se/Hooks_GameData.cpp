...
RelocAddr <_InitGameDataThread_Run_Original> InitGameDataThread_Run_Original(0x00C41840);

typedef void (* _GameDataReady_Original)(bool isReady);
// writes to g_isGameDataReady

// 
RelocAddr <_GameDataReady_Original> GameDataReady_Original(0x00828D00);
...
void Hooks_GameData_Commit()
{
	...
	RelocAddr <uintptr_t> InitGameDataThread_Run(0x02565C48 + 8); 
