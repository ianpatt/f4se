...
RelocAddr <_InitGameDataThread_Run_Original> InitGameDataThread_Run_Original(0x00C3C8E0);

typedef void (* _GameDataReady_Original)(bool isReady);
// writes to g_isGameDataReady

// 
RelocAddr <_GameDataReady_Original> GameDataReady_Original(0x00825B90);
...
void Hooks_GameData_Commit()
{
	...
	RelocAddr <uintptr_t> InitGameDataThread_Run(0x0254EB58 + 8); 
