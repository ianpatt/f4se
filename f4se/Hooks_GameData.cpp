...
RelocAddr <_InitGameDataThread_Run_Original> InitGameDataThread_Run_Original(0x00C414B0);

typedef void (* _GameDataReady_Original)(bool isReady);
// writes to g_isGameDataReady

// 
RelocAddr <_GameDataReady_Original> GameDataReady_Original(0x008289F0);
...
void Hooks_GameData_Commit()
{
	...
	RelocAddr <uintptr_t> InitGameDataThread_Run(0x0255DB58 + 8); 
