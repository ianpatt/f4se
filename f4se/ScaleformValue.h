...
public:
	...
	public:
		...
		DEFINE_MEMBER_FN(HasMember, bool, 0x01AC8B00, void* pData, const char* name);
		DEFINE_MEMBER_FN(GetMember, bool, 0x01AC3440, void* pData, const char* name, GFxValue* pValue, bool isDisplayObj);
		DEFINE_MEMBER_FN(SetMember, bool, 0x01AE1860, void* pData, const char* name, const GFxValue* pValue, bool isDisplayObj);
		DEFINE_MEMBER_FN(Invoke, bool, 0x01ACAC00, void * pData, GFxValue * result, const char * name, GFxValue * args, UInt64 numArgs, UInt8 isDisplayObj);
		DEFINE_MEMBER_FN(CreateEmptyMovieClip, bool, 0x01AA8FB0, void* pData, GFxValue* pValue, const char* instanceName, SInt32 depth);
		DEFINE_MEMBER_FN(AttachMovie, bool, 0x01AA2450, void* pData, GFxValue* pValue, const char* symbolName, const char* instanceName, SInt32 depth, const void * initArgs);
		DEFINE_MEMBER_FN(GetArraySize, UInt32, 0x01ABF3C0, void * pData);
		DEFINE_MEMBER_FN(SetArraySize, bool, 0x01B8BD20, void * pData, UInt32 size);
		DEFINE_MEMBER_FN(GetElement, bool, 0x01AC1E80, void * pData, UInt32 index, GFxValue * value);
		DEFINE_MEMBER_FN(PushBack, bool, 0x01AD81C0, void * pData, GFxValue * value);
		DEFINE_MEMBER_FN(PopBack, bool, 0x01AD5430, void * pData, GFxValue * value);
		DEFINE_MEMBER_FN(VisitElements, void, 0x01AEB4D0, void * pData, ArrayVisitor * visitor, UInt32 idx, SInt32 count);
		DEFINE_MEMBER_FN(GotoLabeledFrame, bool, 0x01AC8880, void * pData, const char * frameLabel, bool stop);
		DEFINE_MEMBER_FN(VisitMembers, void, 0x01AEB600, void * pData, ObjVisitor * visitor, bool isDisplayObj);
		DEFINE_MEMBER_FN(GetText, bool, 0x01AC7080, void * pData, GFxValue * value, bool html);
		DEFINE_MEMBER_FN(SetText, bool, 0x01AE3AD0, void * pData, const char * text, bool html);
		DEFINE_MEMBER_FN(GetDisplayInfo, bool, 0x01AC1790, void * pData, DisplayInfo * displayInfo);
		DEFINE_MEMBER_FN(SetDisplayInfo, bool, 0x01AE0130, void * pData, DisplayInfo * displayInfo);
		DEFINE_MEMBER_FN(AddManaged_Internal, void, 0x01AD14D0, GFxValue * value, void * pData);
		DEFINE_MEMBER_FN(ReleaseManaged_Internal, void, 0x01AD1510, GFxValue * value, void * pData);
	};
	...
	DEFINE_MEMBER_FN(RemoveChild_Internal, void, 0x01B122C0, GFxValue * name);
};
...
public:
	...
	DEFINE_MEMBER_FN_1(Impl_ctor, BSGFxShaderFXTarget *, 0x01AFE900, GFxValue * source);
	DEFINE_MEMBER_FN_2(Impl_ctor_2, BSGFxShaderFXTarget*, 0x01AFE9E0, GFxValue* source, const char* memberName);
	DEFINE_MEMBER_FN_2(Impl_ctor_3, BSGFxShaderFXTarget*, 0x01AFEAC0, GFxMovieView* source, const char* memberName);
	DEFINE_MEMBER_FN_0(Impl_dtor, void, 0x01AFE850);
	DEFINE_MEMBER_FN_2(Impl_AppendShaderFXInfos, void, 0x01AFEC80, BSTArray<UIShaderFXInfo>* colorFX, BSTArray<UIShaderFXInfo>* backgroundFX);
	DEFINE_MEMBER_FN_1(GetColorMultipliersFromType, NiColor*, 0x01AFFE00, NiColor* result); // This function acquires the HUD color by type e.g. normal, PA, hostile
	DEFINE_MEMBER_FN_2(EnableColorMultipliers, void, 0x01AFFAF0, const NiColor* color, float brightness); // Sets explicit component filter color
	DEFINE_MEMBER_FN_0(ApplyBackgroundColorFromType, void, 0x01AFFD40);
};
