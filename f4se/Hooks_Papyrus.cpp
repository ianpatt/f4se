...
RelocAddr <uintptr_t> RegisterPapyrusFunctions_Start(0x01139700 + 0x461);
RelocAddr <uintptr_t> DelayFunctorQueue_Start(0x010EB290 + 0x66);

typedef bool (* _SaveRegistrationHandles)(void * unk1, void * vm, void * handleReaderWriter, void * saveStorageWrapper);
RelocAddr <_SaveRegistrationHandles> SaveRegistrationHandles(0x0119B930);
...
RelocAddr <_LoadRegistrationHandles> LoadRegistrationHandles(0x0119BAB0);
_LoadRegistrationHandles LoadRegistrationHandles_Original = nullptr;

typedef void (* _RevertGlobalData)(void * vm);
RelocAddr <_RevertGlobalData> RevertGlobalData(0x010E94D0);
