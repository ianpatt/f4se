...
RelocAddr <uintptr_t> RegisterPapyrusFunctions_Start(0x0113EC60 + 0x461);
RelocAddr <uintptr_t> DelayFunctorQueue_Start(0x010F07F0 + 0x66);

typedef bool (* _SaveRegistrationHandles)(void * unk1, void * vm, void * handleReaderWriter, void * saveStorageWrapper);
RelocAddr <_SaveRegistrationHandles> SaveRegistrationHandles(0x011A0E90);
...
RelocAddr <_LoadRegistrationHandles> LoadRegistrationHandles(0x011A1010);
_LoadRegistrationHandles LoadRegistrationHandles_Original = nullptr;

typedef void (* _RevertGlobalData)(void * vm);
RelocAddr <_RevertGlobalData> RevertGlobalData(0x010EEA30);
