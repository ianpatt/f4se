...
public:
	...
	public:
		...
		DEFINE_MEMBER_FN(dtor, void, 0x017AE240);
		DEFINE_MEMBER_FN(Impl_Process, void, 0x002F9180, ModelData * modelData, const char * modelName, NiAVObject ** root, UInt32 * typeOut);
	};
};
