...
public:
	...
	public:
		...
		DEFINE_MEMBER_FN(dtor, void, 0x017B3AF0);
		DEFINE_MEMBER_FN(Impl_Process, void, 0x002FC0F0, ModelData * modelData, const char * modelName, NiAVObject ** root, UInt32 * typeOut);
	};
};
