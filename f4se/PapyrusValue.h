...
public:
	...
	struct ArrayData
	{
		...
		DEFINE_MEMBER_FN(Destroy, void, 0x02100E10);
	};
	...
	DEFINE_MEMBER_FN(Set, void, 0x020E55F0, const VMValue * src);
	DEFINE_MEMBER_FN(Destroy, void, 0x020E5130);
...
public:
	...
	DEFINE_MEMBER_FN(Destroy_Internal, void, 0x020E10A0);
};
