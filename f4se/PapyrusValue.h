...
public:
	...
	struct ArrayData
	{
		...
		DEFINE_MEMBER_FN(Destroy, void, 0x01FAB650);
	};
	...
	DEFINE_MEMBER_FN(Set, void, 0x01F8FE30, const VMValue * src);
	DEFINE_MEMBER_FN(Destroy, void, 0x01F8F970);
...
public:
	...
	DEFINE_MEMBER_FN(Destroy_Internal, void, 0x01F8B8E0);
};
