...
public:
	...
	struct ArrayData
	{
		...
		DEFINE_MEMBER_FN(Destroy, void, 0x020FB5F0);
	};
	...
	DEFINE_MEMBER_FN(Set, void, 0x020DFDD0, const VMValue * src);
	DEFINE_MEMBER_FN(Destroy, void, 0x020DF910);
...
public:
	...
	DEFINE_MEMBER_FN(Destroy_Internal, void, 0x020DB880);
};
