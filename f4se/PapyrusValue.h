...
public:
	...
	struct ArrayData
	{
		...
		DEFINE_MEMBER_FN(Destroy, void, 0x020FAEE0);
	};
	...
	DEFINE_MEMBER_FN(Set, void, 0x020DF6C0, const VMValue * src);
	DEFINE_MEMBER_FN(Destroy, void, 0x020DF200);
...
public:
	...
	DEFINE_MEMBER_FN(Destroy_Internal, void, 0x020DB170);
};
