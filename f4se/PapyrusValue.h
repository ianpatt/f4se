...
public:
	...
	struct ArrayData
	{
		...
		DEFINE_MEMBER_FN(Destroy, void, 0x02108840);
	};
	...
	DEFINE_MEMBER_FN(Set, void, 0x020ED020, const VMValue * src);
	DEFINE_MEMBER_FN(Destroy, void, 0x020ECB60);
...
public:
	...
	DEFINE_MEMBER_FN(Destroy_Internal, void, 0x020E8AD0);
};
