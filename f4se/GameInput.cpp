...
// 
RelocPtr <InputEventTable*> g_inputEventTable(0x03273AE0);
// 
RelocPtr <InputDeviceManager*> g_inputDeviceMgr(0x03E75CB8);
// 
RelocPtr <InputManager*> g_inputMgr(0x031F0B88);

// 
RelocPtr<MenuControls*> g_menuControls(0x030E8B10); // BSInputEventReceiver

// 
RelocPtr<PlayerControls*> g_playerControls(0x031F0B80);
