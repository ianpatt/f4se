...
RelocAddr <_SendCustomEvent> SendCustomEvent_Internal(0x011307C0);
RelocAddr <_CallFunctionNoWait> CallFunctionNoWait_Internal(0x0112DEA0);
RelocAddr <_CallGlobalFunctionNoWait> CallGlobalFunctionNoWait_Internal(0x01187550);
