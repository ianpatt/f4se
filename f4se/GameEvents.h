...
DECLARE_EVENT_DISPATCHER(TESCombatEvent, 0x00530BB0)
DECLARE_EVENT_DISPATCHER(TESDeathEvent, 0x00531160)
DECLARE_EVENT_DISPATCHER(TESFurnitureEvent, 0x00531A50)
DECLARE_EVENT_DISPATCHER(TESLoadGameEvent, 0x00531D90)
DECLARE_EVENT_DISPATCHER(TESObjectLoadedEvent, 0x005321A0)
DECLARE_EVENT_DISPATCHER(TESInitScriptEvent, 0x00531BF0)
