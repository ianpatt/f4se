...
DECLARE_EVENT_DISPATCHER(TESCombatEvent, 0x0052DC50)
DECLARE_EVENT_DISPATCHER(TESDeathEvent, 0x0052E200)
DECLARE_EVENT_DISPATCHER(TESFurnitureEvent, 0x0052EAF0)
DECLARE_EVENT_DISPATCHER(TESLoadGameEvent, 0x0052EE30)
DECLARE_EVENT_DISPATCHER(TESObjectLoadedEvent, 0x0052F240)
DECLARE_EVENT_DISPATCHER(TESInitScriptEvent, 0x0052EC90)
