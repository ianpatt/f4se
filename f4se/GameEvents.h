...
DECLARE_EVENT_DISPATCHER(TESCombatEvent, 0x004DCC00)
DECLARE_EVENT_DISPATCHER(TESDeathEvent, 0x004DD1B0)
DECLARE_EVENT_DISPATCHER(TESFurnitureEvent, 0x004DDAA0)
DECLARE_EVENT_DISPATCHER(TESLoadGameEvent, 0x004DDDE0)
DECLARE_EVENT_DISPATCHER(TESObjectLoadedEvent, 0x004DE1F0)
DECLARE_EVENT_DISPATCHER(TESInitScriptEvent, 0x004DDC40)
