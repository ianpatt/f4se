...
DECLARE_EVENT_DISPATCHER(TESCombatEvent, 0x0052E180)
DECLARE_EVENT_DISPATCHER(TESDeathEvent, 0x0052E730)
DECLARE_EVENT_DISPATCHER(TESFurnitureEvent, 0x0052F020)
DECLARE_EVENT_DISPATCHER(TESLoadGameEvent, 0x0052F360)
DECLARE_EVENT_DISPATCHER(TESObjectLoadedEvent, 0x0052F770)
DECLARE_EVENT_DISPATCHER(TESInitScriptEvent, 0x0052F1C0)
