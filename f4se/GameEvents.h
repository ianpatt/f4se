...
DECLARE_EVENT_DISPATCHER(TESCombatEvent, 0x00530EE0)
DECLARE_EVENT_DISPATCHER(TESDeathEvent, 0x00531490)
DECLARE_EVENT_DISPATCHER(TESFurnitureEvent, 0x00531D80)
DECLARE_EVENT_DISPATCHER(TESLoadGameEvent, 0x005320C0)
DECLARE_EVENT_DISPATCHER(TESObjectLoadedEvent, 0x005324D0)
DECLARE_EVENT_DISPATCHER(TESInitScriptEvent, 0x00531F20)
