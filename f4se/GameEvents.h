...
// 
DECLARE_EVENT_DISPATCHER(TESCombatEvent, 0x004420F0 * 0)

// 
DECLARE_EVENT_DISPATCHER(TESDeathEvent, 0x00442550 * 0)

// 
DECLARE_EVENT_DISPATCHER(TESFurnitureEvent, 0x00442C30 * 0)

// 
DECLARE_EVENT_DISPATCHER(TESLoadGameEvent, 0x00442EB0 * 0)

// 
DECLARE_EVENT_DISPATCHER(TESObjectLoadedEvent, 0x004431D0 * 0)

// 
DECLARE_EVENT_DISPATCHER(TESInitScriptEvent, 0x00442D70 * 0)
