...
DECLARE_EVENT_DISPATCHER(TESCombatEvent, 0x00530BC0)
DECLARE_EVENT_DISPATCHER(TESDeathEvent, 0x00531170)
DECLARE_EVENT_DISPATCHER(TESFurnitureEvent, 0x00531A60)
DECLARE_EVENT_DISPATCHER(TESLoadGameEvent, 0x00531DA0)
DECLARE_EVENT_DISPATCHER(TESObjectLoadedEvent, 0x005321B0)
DECLARE_EVENT_DISPATCHER(TESInitScriptEvent, 0x00531C00)
