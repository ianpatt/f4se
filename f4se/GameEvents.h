...
DECLARE_EVENT_DISPATCHER(TESCombatEvent, 0x0052DD90)
DECLARE_EVENT_DISPATCHER(TESDeathEvent, 0x0052E340)
DECLARE_EVENT_DISPATCHER(TESFurnitureEvent, 0x0052EC30)
DECLARE_EVENT_DISPATCHER(TESLoadGameEvent, 0x0052EF70)
DECLARE_EVENT_DISPATCHER(TESObjectLoadedEvent, 0x0052F380)
DECLARE_EVENT_DISPATCHER(TESInitScriptEvent, 0x0052EDD0)
