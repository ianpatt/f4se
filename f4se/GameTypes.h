...
public:
	...
	DEFINE_MEMBER_FN_0(LockForRead, void, 0x01654140);
	DEFINE_MEMBER_FN_0(LockForWrite, void, 0x016541C0);

	DEFINE_MEMBER_FN_0(UnlockRead, void, 0x01654410);
	DEFINE_MEMBER_FN_0(UnlockWrite, void, 0x01654420);
};
...
public:
	...
	struct Ref
	{
		...
		// 
		DEFINE_MEMBER_FN(ctor, Ref *, 0x01676F20, const char * buf);
		// 
		DEFINE_MEMBER_FN(ctor_w, Ref *, 0x01677DF0, const wchar_t * buf);
		// 
		DEFINE_MEMBER_FN(Set, Ref *, 0x01677060, const char * buf);
		DEFINE_MEMBER_FN(Set_w, Ref *, 0x01678FE0, const wchar_t * buf);

		DEFINE_MEMBER_FN(Release, void, 0x016781E0);
