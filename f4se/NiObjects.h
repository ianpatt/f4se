...
public:
	...
	DEFINE_MEMBER_FN(Internal_IsEqual, bool, 0x0159F830, NiObject * object);
};
...
public:
	...
	DEFINE_MEMBER_FN(Internal_AddExtraData, bool, 0x015A1EA0, NiExtraData * extraData);
};
...
public:
	...
	DEFINE_MEMBER_FN(GetAVObjectByName, NiAVObject*, 0x01685A00, BSFixedString * name, bool unk1, bool unk2);
	DEFINE_MEMBER_FN(SetScenegraphChange, void, 0x015ADCE0);
