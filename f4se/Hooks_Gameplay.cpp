...
// 
RelocAddr <char *> g_gameVersion(0x0246BD40);

RelocAddr <uintptr_t> kHook_ShowVersion_Offset(0x00AFE460 + 0x50 + 3);
RelocAddr <uintptr_t> kHook_ShowVersion_OffsetBase(0x00AFE460 + 0x50 + 7);
...
RelocAddr <uintptr_t> kHook_CustomControlMap_Offset(0x0166BFC0);
RelocAddr <void *> kHook_CustomControlMap_Return(0x0166BFC0 + 5);
