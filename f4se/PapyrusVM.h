...
public:
	...
	DEFINE_MEMBER_FN(SendPapyrusEvent, void, 0x010E86A0, UInt64 handle, const BSFixedString & eventName, std::function<bool(void*)> functor); // Signature not correct yet
};
