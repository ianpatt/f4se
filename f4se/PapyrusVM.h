...
public:
	...
	DEFINE_MEMBER_FN(SendPapyrusEvent, void, 0x010E80E0, UInt64 handle, const BSFixedString & eventName, std::function<bool(void*)> functor); // Signature not correct yet
};
