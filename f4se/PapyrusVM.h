...
public:
	...
	DEFINE_MEMBER_FN(SendPapyrusEvent, void, 0x010ED2F0, UInt64 handle, const BSFixedString & eventName, std::function<bool(void*)> functor); // Signature not correct yet
};
