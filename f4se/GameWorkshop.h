...
public:
	...
	DEFINE_MEMBER_FN_1(ctor, ContextData*, 0x003897F0, Actor * refr);
};
...
public:
	...
	DEFINE_MEMBER_FN_1(AddItem, void, 0x00387090, TESObjectREFR* akRef);
	DEFINE_MEMBER_FN_3(AddConnection, void, 0x003876D0, TESObjectREFR* akRef1, TESObjectREFR* akRef2, TESObjectREFR* akWireRef);
};
