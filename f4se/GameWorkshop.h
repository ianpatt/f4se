...
public:
	...
	DEFINE_MEMBER_FN_1(ctor, ContextData*, 0x003866A0, Actor * refr);
};
...
public:
	...
	DEFINE_MEMBER_FN_1(AddItem, void, 0x00383F40, TESObjectREFR* akRef);
	DEFINE_MEMBER_FN_3(AddConnection, void, 0x00384580, TESObjectREFR* akRef1, TESObjectREFR* akRef2, TESObjectREFR* akWireRef);
};
