...
public:
	...
	DEFINE_MEMBER_FN_1(ctor, ContextData*, 0x003894D0, Actor * refr);
};
...
public:
	...
	DEFINE_MEMBER_FN_1(AddItem, void, 0x00386D70, TESObjectREFR* akRef);
	DEFINE_MEMBER_FN_3(AddConnection, void, 0x003873B0, TESObjectREFR* akRef1, TESObjectREFR* akRef2, TESObjectREFR* akWireRef);
};
