...
public:
	...
	DEFINE_MEMBER_FN_1(MountImage, bool, 0x01C9B9C0, NiTexture **);
	DEFINE_MEMBER_FN_1(UnmountImage, bool, 0x01C9BC60, NiTexture **);
};
...
public:
	...
	DEFINE_MEMBER_FN(LoadMovie, bool, 0x01B1B1D0, IMenu * menu, GFxMovieView *&, const char * name, const char * stagePath, UInt32 flags);
};
