...
public:
	...
	DEFINE_MEMBER_FN(ModifyFlag, void, 0x0030A6F0, UInt32 flag, bool doSet, bool unk1); // unk1 = 1 (appears to select which actor flags to use)
	DEFINE_MEMBER_FN(GetLevel, UInt16, 0x0030A7E0);
};
...
public:
	...
	DEFINE_MEMBER_FN(Get, void, 0x0030EA10, BSString * out, TESForm * parent);
};
...
public:
	...
	public:
		...
		DEFINE_MEMBER_FN(ctor, void, 0x007685A0, TESForm * a1, TESForm * a2, UInt64 unk1); // a1 might be player or subject, not sure yet
	};

	MEMBER_FN_PREFIX(Condition);
	// 
	DEFINE_MEMBER_FN(Evaluate, bool, 0x0076A0E0, Evaluator * eval); // Evaluates only a single condition
};
...
public:
	...
	DEFINE_MEMBER_FN_4(AttachSkinnedObject, NiNode*, 0x0035E960, NiNode* objectRoot, NiNode* parent, UInt32 bipedIndex, bool abFirstPerson);
};
