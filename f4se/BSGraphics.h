...
public:
	...
	DEFINE_MEMBER_FN_4(CreateTriShape, TriShape*, 0x01818760, UInt32* arDataSize, void* apData, UInt64 auiVertexDesc, IndexBuffer* apIndexBuffer);
	DEFINE_MEMBER_FN_3(CreateVertexBuffer, VertexBuffer*, 0x01819FD0, UInt32* auiDataSize, SInt8* apData, UInt32 auiStride);
	DEFINE_MEMBER_FN_2(CreateIndexBuffer, IndexBuffer*, 0x0181A2F0, UInt32 auiIndexCount, const UInt16* apIndices);
};
...
public:
	...
	DEFINE_MEMBER_FN_1(LockTextureType, void, 0x0183A810, UInt32 type);
	DEFINE_MEMBER_FN_1(ReleaseTextureType, void, 0x0183A8A0, UInt32 type);
	DEFINE_MEMBER_FN_4(GetRenderData, BSRenderData *, 0x0183A770, UInt32 type, UInt64 unk1, UInt64 unk2, UInt32 unk3); // type, 0, 1, 0
	DEFINE_MEMBER_FN_3(Unk_01, void, 0x0183A7C0, UInt32 type, BSRenderData *, UInt8 unk3); // type, rendererData, 1
	DEFINE_MEMBER_FN_4(CreateRenderTarget, void, 0x01838C70, UInt32 aIndex, const RenderTargetProperties& properties, UInt8 aPersistent);
};
}
