...
RelocAddr <_CreateMenuControlHandlers> CreateMenuControlHandlers(0x00FEDA00);
...
RelocAddr <_CreatePlayerControlHandlers> CreatePlayerControlHandlers(0x00D568D0);
