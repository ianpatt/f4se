...
RelocAddr <_CreateMenuControlHandlers> CreateMenuControlHandlers(0x01074990);
...
RelocAddr <_CreatePlayerControlHandlers> CreatePlayerControlHandlers(0x00DDC780);
