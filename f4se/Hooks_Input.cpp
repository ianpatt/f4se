...
RelocAddr <_CreateMenuControlHandlers> CreateMenuControlHandlers(0x01074E80);
...
RelocAddr <_CreatePlayerControlHandlers> CreatePlayerControlHandlers(0x00DDCCB0);
