...
public:
	...
	DEFINE_MEMBER_FN(LoadPreset, void, 0x00BBC890, UInt32 presetIndex); // Loads preset by index onto the actor
};
...
public:
	...
	DEFINE_MEMBER_FN(ApplyDynamicData, void, 0x006DE050, BSTriShape * trishape);
};
