...
public:
	...
	DEFINE_MEMBER_FN(ctor, TESNPC*, 0x0064B990);
	DEFINE_MEMBER_FN(HasOverlays, bool, 0x0065C070);
	DEFINE_MEMBER_FN(GetOverlayHeadParts, BGSHeadPart**, 0x0065C180);
	DEFINE_MEMBER_FN(GetNumOverlayHeadParts, int, 0x0065C230);
	DEFINE_MEMBER_FN(GetSex, SInt64, 0x00641B40); // npc->actorData.unk08 & 1
	DEFINE_MEMBER_FN(ChangeHeadPartRemovePart, void, 0x00652830, BGSHeadPart *, bool bRemoveExtraParts);
	DEFINE_MEMBER_FN(ChangeHeadPart, void, 0x00656C40, BGSHeadPart *);
	DEFINE_MEMBER_FN(GetSkinColorFromTint, void, 0x00652BA0, NiColorA * outColor, BGSCharacterTint::PaletteEntry* paletteEntry, bool allowCustomization); // This function alters the npc's Skin Color values
	DEFINE_MEMBER_FN_0(GetFacialBoneMorphIntensity, float, 0x006520B0);
	DEFINE_MEMBER_FN_1(SetFacialBoneMorphIntensity, void, 0x00652050, float intensity);
