...
public:
	...
	DEFINE_MEMBER_FN(Copy, void, 0x021C5F90, const BSLightingShaderMaterialBase * src);
};
...
public:
	...
	DEFINE_MEMBER_FN(ctor, void, 0x021629D0);
	DEFINE_MEMBER_FN(dtor, void, 0x00597A40);
	DEFINE_MEMBER_FN(ApplyMaterialData, void, 0x02169AD0, BSGeometry * trishape, bool unk1);
};
