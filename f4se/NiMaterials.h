...
public:
	...
	DEFINE_MEMBER_FN(Copy, void, 0x021C6070, const BSLightingShaderMaterialBase * src);
};
...
public:
	...
	DEFINE_MEMBER_FN(ctor, void, 0x02162AB0);
	DEFINE_MEMBER_FN(dtor, void, 0x00597A50);
	DEFINE_MEMBER_FN(ApplyMaterialData, void, 0x02169BB0, BSGeometry * trishape, bool unk1);
};
