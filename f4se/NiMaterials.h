...
public:
	...
	DEFINE_MEMBER_FN(Copy, void, 0x021CDAA0, const BSLightingShaderMaterialBase * src);
};
...
public:
	...
	DEFINE_MEMBER_FN(ctor, void, 0x0216A4E0);
	DEFINE_MEMBER_FN(dtor, void, 0x00597D70);
	DEFINE_MEMBER_FN(ApplyMaterialData, void, 0x021715E0, BSGeometry * trishape, bool unk1);
};
