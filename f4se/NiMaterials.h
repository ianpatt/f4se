...
public:
	...
	DEFINE_MEMBER_FN(Copy, void, 0x021C14A0, const BSLightingShaderMaterialBase * src);
};
...
public:
	...
	DEFINE_MEMBER_FN(ctor, void, 0x0215DEE0);
	DEFINE_MEMBER_FN(dtor, void, 0x00595010);
	DEFINE_MEMBER_FN(ApplyMaterialData, void, 0x02164FE0, BSGeometry * trishape, bool unk1);
};
