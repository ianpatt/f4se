...
RelocAddr <_BSScaleformManager_Ctor> BSScaleformManager_Ctor(0x01B15B90);
...
RelocAddr <_BSScaleformTint> BSScaleformTint(0x01B00470);
_BSScaleformTint BSScaleformTint_Original = nullptr;

RelocAddr <uintptr_t> ScaleformInitHook_Start(0x01B163A0 + 0x226);

RelocAddr <uintptr_t> IMenuCreateHook_Start(0x01A7B8F0 + 0xA0F);

// 
RelocAddr <uintptr_t> SetMenuName(0x01677A40);
