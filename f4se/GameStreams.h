...
public:
	...
	DEFINE_MEMBER_FN(Construct, BSResourceNiBinaryStream *, 0x016B4660, const char * filePath, UInt8 unk1, UInt64 unk2, SInt8 unk3);	// unk1 = 0, unk2 = 0, unk3 = 0
	DEFINE_MEMBER_FN(ReadLine, UInt32, 0x016B4B90, char * dst, UInt32 dstLen, UInt32 terminator);
	DEFINE_MEMBER_FN(Destroy, void, 0x016B4950);	// ??_7BSResourceNiBinaryStream@@6B@ first entry
	DEFINE_MEMBER_FN(IsValid, bool, 0x016B4A90, void);
	DEFINE_MEMBER_FN(Seek, void, 0x016B4AA0, SInt64);
	DEFINE_MEMBER_FN(Unk_04, SInt64, 0x016B4B00, void * unk1);
	DEFINE_MEMBER_FN(Read, UInt32, 0x016B4C50, void * buf, UInt64 length);
	DEFINE_MEMBER_FN(Write, UInt32, 0x016B4CE0, void * buf, UInt64 length);
