...
public:
	...
	// 
	DEFINE_MEMBER_FN(Internal_LoadBinary, void, 0x016BB9E0, void * stream);
	// 
	DEFINE_MEMBER_FN(Internal_SaveBinary, void, 0x016BBA80, void * stream);
};
...
protected:
	...
	DEFINE_MEMBER_FN(ctor, BSFaceGenBaseMorphExtraData*, 0x006E6EE0, BSTriShape * shape);
};
