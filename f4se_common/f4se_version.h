...
#define F4SE_VERSION_INTEGER_BETA	9
#define F4SE_VERSION_VERSTRING		"0, 0, 7, 9"
#define F4SE_VERSION_PADDEDSTRING	"0033"
#define F4SE_VERSION_RELEASEIDX		33
...
#define RUNTIME_VERSION_1_11_169	MAKE_EXE_VERSION(1, 11, 169)	// 0x010B0A90	hotfix
#define RUNTIME_VERSION_1_11_191	MAKE_EXE_VERSION(1, 11, 191)	// 0x010B0BF0	hotfix
#define RUNTIME_VERSION_1_11_221	MAKE_EXE_VERSION(1, 11, 221)	// 0x010B0DD0	
#define RUNTIME_VERSION_1_11_240	MAKE_EXE_VERSION(1, 11, 240)	// 0x010B0F00	creation club
...
#define CURRENT_RELEASE_RUNTIME		RUNTIME_VERSION_1_11_240
#define CURRENT_RELEASE_F4SE_STR	"0.7.9"
